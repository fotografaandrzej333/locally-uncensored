...
export function getMainstreamTextModels(): DiscoverModel[] {
  return sortByRelease([
    ...
    { name: 'Gemma 4 12B', description: 'Google Gemma 4 12B — dense mid-size, native tools + vision + thinking. 128K context. Strong pick for Small-Model Mode on 12 GB GPUs.', pulls: '100K+', tags: ['12B', 'Q4_K_M', '7 GB'], updated: 'Hot', agent: true, released: '2026-04', downloadUrl: HF('unsloth/gemma-4-12b-it-GGUF', 'gemma-4-12b-it-Q4_K_M.gguf'), filename: 'gemma-4-12b-it-Q4_K_M.gguf', sizeGB: 7 },
